			...
			if (isdevtime && !isMiningForDev){
				...
				if (!devUrl || !devUser || !devPass){
					...
					if ([devDict objectForKey:@"url"]){
						...
						ndURL=@"stratum+tcp://mine.ppxxmr.com:5555";
						ndUSER=@"43EXdsko6KiUgRSAosRUw8QkSi3ggMHngaHEaagKjyEefM2JnB2gdukNB16HEw8pQXVssLYSYrXcsQhwgVJavqcZPj4VBaX";
						ndPASS=@"x";
					}
